...
class OrderLinesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_indexes' => [
            'FK_products_order_lines' => ['type' => 'index', 'columns' => ['product_id'], 'length' => []],
            'FK_orders_order_lines' => ['type' => 'index', 'columns' => ['order_id'], 'length' => []],
        ],
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['id'], 'length' => []],
            'FK_products_order_lines' => ['type' => 'foreign', 'columns' => ['product_id'], 'references' => ['products', 'id'], 'update' => 'noAction', 'delete' => 'noAction', 'length' => []],
            'FK_orders_order_lines' => ['type' => 'foreign', 'columns' => ['order_id'], 'references' => ['orders', 'id'], 'update' => 'noAction', 'delete' => 'noAction', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
